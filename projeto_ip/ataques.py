...
GOLPES_DB = {
    ...
    "Encarar":          {"poder": 1,  "tipo": "Normal",   "precisao": 100},
    "Abanar o Rabo":    {"poder": 1,  "tipo": "Normal",   "precisao": 100},
    ...
    "Meteoro Veloz":    {"poder": 60, "tipo": "Normal",   "precisao": 100},
    "Mordida":          {"poder": 60, "tipo": "Normal",   "precisao": 100},
    "Enrolar":          {"poder": 15, "tipo": "Normal",   "precisao": 90},
    "Autodestruicao":   {"poder": 200, "tipo": "Normal",  "precisao": 100},
    ...
    # Golpes de Tipo Lutador
    "Golpe de Karate":  {"poder": 50, "tipo": "Lutador",  "precisao": 100},
    "Chute Baixo":      {"poder": 50, "tipo": "Lutador",  "precisao": 100},
    "Eremesso Sismico": {"poder": 40, "tipo": "Lutador",  "precisao": 100},
    ...
    # Golpes de Tipo Terra
    "Ataque de Areia":  {"poder": 1,  "tipo": "Terrestre","precisao": 100},
    "Ataque de Areia":  {"poder": 0,  "tipo": "Terra",    "precisao": 100},
    "Magnitude":        {"poder": 70, "tipo": "Terra",    "precisao": 100},
    "Osso Clube":       {"poder": 65, "tipo": "Terra",    "precisao": 85},
    "Bonemerangue":     {"poder": 50, "tipo": "Terra",    "precisao": 90},

    # Golpes de Tipo Pedra
    "Arremesso de Rocha": {"poder": 50, "tipo": "Pedra",  "precisao": 90},

    # Golpes de Tipo Voador
    ...
    # Golpes de Tipo Inseto
    "Tiro de Teia":     {"poder": 1,  "tipo": "Inseto",   "precisao": 95},

    # Golpes de Tipo Dragão
